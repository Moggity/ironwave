...
const EXPORTS = `return {
  ...
  logLandmarkSnapshot, recalibrateLandmarks, landmarksForBlock, exVolumeAttribution,
  ...
  validateFocusWeek, musclePool, FOCUS_MAX, FOCUS_SCALE_MIGRATION, FOCUS_HEAD_ROTATION,
  BB_DAY_TEMPLATES,
